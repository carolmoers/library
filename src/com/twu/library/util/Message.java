...
public class Message {
    ...
    public final static String UNSUCCESSFUL_CHECKOUT = "The book is not available.";
    public final static String SUCCESSFUL_RETURN = "Thank you for returning the book.";
    public final static String UNSUCCESSFUL_RETURN = "It is not a valid book to return.";
}
